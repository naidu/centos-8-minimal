...
RUN curl -L -o /root/CentOS-8.3.2011-x86_64-boot.iso http://isoredirect.centos.org/centos/8/isos/x86_64/CentOS-8.3.2011-x86_64-dvd1.iso
RUN echo $(sha256sum /root/CentOS-8.3.2011-x86_64-boot.iso)
